...
ifneq (Darwin,$(OS))
  ...
  OSX_DMG_BUILD = /Users/larkost/Projects/rethinkdb/packaging/osx/create_dmg.py --server-root "$(OSX_PACKAGE_DIR)/pkg" --ouptut-location "$(OSX_PACKAGE_DIR)/rethinkdb.dmg" --signing-name "$(OSX_SIGNATURE_NAME)"
else ifeq ($(REQUIRE_SIGNED),1)
  OSX_DMG_BUILD = $(error Certificate not found: $(OSX_SIGNATURE_NAME))
else
  OSX_DMG_BUILD = /Users/larkost/Projects/rethinkdb/packaging/osx/create_dmg.py --server-root "$(OSX_PACKAGE_DIR)/pkg" --ouptut-location "$(OSX_PACKAGE_DIR)/rethinkdb.dmg"
endif

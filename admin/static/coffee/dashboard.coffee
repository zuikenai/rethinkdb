...
module 'DashboardView', ->
    ...
    class @DashboardContainer extends Backbone.View
        ...
        fetch_data: =>
            ...
            sindex_query = r.expr(
                num_sindex_issues: A.current_issues.count(type: 'outdated_index')
                num_sindexes_constructing: A.jobs.count(type: 'index_construction')
            )
            @sindex_timer = driver.run sindex_query, 2000, dashboard_callback
        ...
        remove: =>
            ...
            driver.stop_timer @sindex_timer
            if @dashboard_view

...
public:
    ...
    // This throws declaration is commented out because it crashes clang 3.4.
    virtual void sync_from(peer_id_t peer, signal_t *interruptor)
        /* THROWS_ONLY(interrupted_exc_t, sync_failed_exc_t) */ = 0;
...
public:
    ...
    // This throws declaration is commented out because it crashes clang 3.4.
    virtual void sync_to(peer_id_t peer, signal_t *interruptor)
        /* THROWS_ONLY(interrupted_exc_t, sync_failed_exc_t) */ = 0;
};

...
struct rdb_protocol_t {
    ...
    struct read_t {
        ...
        bool use_snapshot() const THROWS_NOTHING { return checked_boost_get<rget_read_t>(&read); }

        // Returns true if this read should be sent to every replica.
        bool all_read() const THROWS_NOTHING { return checked_boost_get<sindex_status_t>(&read); }

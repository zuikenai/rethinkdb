...
rdb_blob_wrapper_t::rdb_blob_wrapper_t(default_block_size_t block_size, char *ref,
                                       int maxreflen)
    : internal(block_size, ref, maxreflen) { }

rdb_blob_wrapper_t::rdb_blob_wrapper_t(
        default_block_size_t block_size, char *ref, int maxreflen,
...
int rdb_blob_wrapper_t::refsize(default_block_size_t block_size) const {

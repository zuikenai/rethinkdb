...
struct orig_btree_t {
    ...
    static int compare_entry_to_entry(const entry_t *, const entry_t *) {
        // RSI: Implement this.
        return 0;
    }

    static bool entry_fits(UNUSED value_sizer_t *sizer, const entry_t *, UNUSED size_t length_available) {
        // RSI: Implement this.
        return false;
    }

    static size_t entry_size(UNUSED value_sizer_t *sizer, const entry_t *) {
        // RSI: Implement this.
        return 0;
    }

    static bool is_live(const entry_t *) {
        // RSI: Implement this.
        return false;
    }
};

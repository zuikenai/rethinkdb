...
module('NamespaceView', function() {
  this.DatabaseList = (function(_super) {
    ...
    DatabaseList.prototype.initialize = function() {
      ...
      DatabaseList.__super__.initialize.call(this, databases, NamespaceView.DatabaseListElement, '.collapsible-list', {
        sort: function(a, b) {
  ...
  this.AddNamespaceModal = (function(_super) {
    ...
    AddNamespaceModal.prototype.render = function() {
      var datacenter, machine, ordered_databases, ordered_datacenters, slice_index, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
      ...
      ordered_databases = databases.map(function(d) {
        return {
          id: d.get('id'),
          name: d.get('name')
        };
      });
      ordered_databases = _.sortBy(ordered_databases, function(d) {
        return d.name;
      });
  ...
  this.Sharding = (function(_super) {
    ...
    Sharding.prototype.shard_table = function(event) {
      ...
      if (this.check_shards_changes() === true) {
        ...
        return $.ajax({
          processData: false,
          url: ("ajax/semilattice/" + this.model.attributes.protocol + "_namespaces/") + ("" + (this.model.get('id')) + "?prefer_distribution_for=" + (this.model.get('id'))),
          type: 'POST',
          contentType: 'application/json',
          data: JSON.stringify(data),
          success: this.on_success,
        ...
        case 'table':
          ...
          if (Object.prototype.toString.call(this.results) === '[object Array]') {
            if (this.results.length === 0) {
              this.$('.table_view').html(this.template_no_result());
            } else {
...
module('DataUtils', function() {
  ...
  this.directory_activities = null;
  this.directory_activities_by_namespaces = null;
  this.reset_directory_activities = function() {
    this.directory_activities = null;
    return this.directory_activities_by_namespaces = null;
  };
  this.get_directory_activities = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (namespace_id in bcards) {
          ...
          for (activity_id in activity_map) {
            ...
            this.directory_activities[activity_id] = {
              value: activity,
              machine_id: machine.get('id'),
              namespace_id: namespace_id
            };
    ...
    return this.directory_activities;
  };
  this.get_directory_activities_by_namespaces = function() {
    ...
    return this.directory_activities_by_namespaces;
  };

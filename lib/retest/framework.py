...
parser.add_argument('-E', '--examine', action='append', metavar='GLOB',
...
def run(all_tests, args):
    ...
    if args.load or args.tree or args.examine:
        old_tests_mode(all_tests, args.load, filter, args.verbose, args.mode, args.only_failed, args.tree, args.examine)
        return
...
def old_tests_mode(all_tests, load, filter, verbose, mode, only_failed, tree, examine):
